 ...
 */
public class DriveToDistanceTimeOut extends AutoGoStraightCommand {
	 ...
	 *            The distance to drive to.
	 */
	public DriveToDistanceTimeOut(double speed, double angle, double distance, double timeOut) {
		super(angle);
